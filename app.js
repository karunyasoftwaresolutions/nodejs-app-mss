...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Mohan Technologies. Please Contact +91-8686989972 for more information or send an email to reddymohan973@gmail.com <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        res.send({
		'name': 'Mohan Technologies',
		'technology': 'DevOps',
		'contact' : '8686989972',
		'email': 'reddymohan973@gmail.com'
	            });
